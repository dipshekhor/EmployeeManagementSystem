...
public class DashboardController implements Initializable {
    ...
    @FXML
    private TableView<employeeDatabase> addEmployee_tableView;

    @FXML
    private TableColumn<employeeDatabase, String> addEmployee_col_employeeID;

    @FXML
    private TableColumn<employeeDatabase, String> addEmployee_col_firstName;

    @FXML
    private TableColumn<employeeDatabase, String> addEmployee_col_lastName;

    @FXML
    private TableColumn<employeeDatabase, String> addEmployee_col_gender;

    @FXML
    private TableColumn<employeeDatabase, String> addEmployee_col_phoneNum;

    @FXML
    private TableColumn<employeeDatabase, String> addEmployee_col_position;

    @FXML
    private TableColumn<employeeDatabase, String> addEmployee_col_date;
    ...
    @FXML
    private TableView<employeeDatabase> salary_tableView;

    @FXML
    private TableColumn<employeeDatabase, String> salary_col_employeeID;

    @FXML
    private TableColumn<employeeDatabase, String> salary_col_firstName;

    @FXML
    private TableColumn<employeeDatabase, String> salary_col_lastName;

    @FXML
    private TableColumn<employeeDatabase, String> salary_col_position;

    @FXML
    private TableColumn<employeeDatabase, String> salary_col_salary;
    ...
    public void homeTotalEmployees() {
        ...
        String sql = "SELECT COUNT(id) FROM login.employee";
    ...
    public void homeEmployeeTotalPresent() {
        ...
        String sql = "SELECT COUNT(id) FROM login.employee_info";
    ...
    public void homeTotalInactive() {
        ...
        String sql = "SELECT COUNT(id) FROM login.employee_info WHERE salary = '0.0'";
    ...
    public void homeChart() {
        ...
        String sql = "SELECT date, COUNT(id) FROM login.employee GROUP BY date ORDER BY TIMESTAMP(date) ASC LIMIT 7";
    ...
    public void addEmployeeAdd() {
        ...
        String sql = "INSERT INTO login.employee "
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                String check = "SELECT employee_id FROM login.employee WHERE employee_id = '"
                ...
                if (result.next()) {
                    ...
                    String insertInfo = "INSERT INTO login.employee_info "
    ...
    public void addEmployeeUpdate() {
        ...
        String sql = "UPDATE login.employee SET firstName = '"
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    String checkData = "SELECT * FROM login.employee_info WHERE employee_id = '"
                            + addEmployee_employeeID.getText() + "'";
                    ...
                    String updateInfo = "UPDATE login.employee_info SET firstName = '"
                            + addEmployee_firstName.getText() + "', lastName = '"
    ...
    public void addEmployeeDelete() {
        ...
        String sql = "DELETE FROM login.employee WHERE employee_id = '"
                + addEmployee_employeeID.getText() + "'";
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    String deleteInfo = "DELETE FROM login.employee_info WHERE employee_id = '"
                            + addEmployee_employeeID.getText() + "'";
    ...
    public void addEmployeeSearch() {
        ...
        FilteredList<employeeDatabase> filter = new FilteredList<>(addEmployeeList, e -> true);
        ...
        SortedList<employeeDatabase> sortList = new SortedList<>(filter);

        sortList.comparatorProperty().bind(addEmployee_tableView.comparatorProperty());
        addEmployee_tableView.setItems(sortList);
    }

    public ObservableList<employeeDatabase> addEmployeeListData() {

        ObservableList<employeeDatabase> listData = FXCollections.observableArrayList();
        String sql = "SELECT * FROM login.employee";
        ...
        try {
            prepare = connect.prepareStatement(sql);
            result = prepare.executeQuery();
            employeeDatabase employeeD;

            while (result.next()) {
                employeeD = new employeeDatabase(result.getInt("employee_id"),
    ...
    private ObservableList<employeeDatabase> addEmployeeList;
    ...
    public void addEmployeeSelect() {
        employeeDatabase employeeD = addEmployee_tableView.getSelectionModel().getSelectedItem();
        ...
        image = new Image(uri, 116, 129, false, true);
        addEmployee_image.setImage(image);
    }

    public void salaryUpdate() {

        String sql = "UPDATE login.employee_info SET salary = '" + salary_salary.getText()
    ...
    public ObservableList<employeeDatabase> salaryListData() {

        ObservableList<employeeDatabase> listData = FXCollections.observableArrayList();

        String sql = "SELECT * FROM login.employee_info";
    ...
    private ObservableList<employeeDatabase> salaryList;
    ...
    public void salarySelect() {
        ...
        employeeDatabase employeeD = salary_tableView.getSelectionModel().getSelectedItem();
